...
import "./LetterAngela.css";

const LetterAngela = () => {
  return (
    <div>
      <div style={{ background: "rgba(255, 238, 223, 0.5)" }} className="mt-12">
        <h1 className="letter-angela-title mb-12">A letter from Angela</h1>
        <div
