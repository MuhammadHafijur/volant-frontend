  ...
  return (
    <div>
      <div className="w-9/12 mx-auto">
        <h1 className="text-3xl font-semibold font-hatton text-center my-16">
          Our Handmade, Designer Diffuser
        </h1>
        <div className="grid grid-cols-1 md:grid-cols-2 my-12 font-mulish">
          <div className="w-3/4 mx-auto">
            <div className="flex-none md:flex justify-center items-center mb-8">
              <img className="mx-auto md:mr-8" src={award} alt="" />
              <p>
                2022 Award-winning Scandinavian <br /> design
              </p>
            </div>
            <div className="flex-none md:flex justify-center items-center mb-8">
              <img className="mx-auto md:mr-8" src={home} alt="" />
              <p>
                Scents up to 40 square meters of <br /> your home
              </p>
            </div>
            <div className="flex-none md:flex justify-center items-center mb-8">
              <img className="mx-auto md:mr-8" src={ceramic} alt="" />
              <p>
                Handmade using sustainable, high <br /> quality ceramic
              </p>
            </div>
            <div className="flex-none md:flex justify-center items-center">
              <img className="mx-auto md:mr-8" src={candles} alt="" />
              <p className="">
          ...
          <div className="w-3/4">
            <div className="flex-none md:flex justify-center  items-center mb-8">
              <img className="mx-auto md:mr-8" src={clock} alt="" />
              <p>
                4-8 hours runtime and adjustable <br /> LED-light
              </p>
            </div>
            <div className="flex-none md:flex justify-center  items-center mb-8">
              <img className="mx-auto md:mr-8" src={scents} alt="" />
              <p>
            ...
            <div className="flex-none md:flex justify-center  items-center mb-8">
              <img className="mx-auto md:mr-8" src={volant} alt="" />
              <p>
            ...
            <div className="flex-none md:flex justify-center  items-center">
              <img className="mx-auto md:mr-8" src={oils} alt="" />
              <p>
